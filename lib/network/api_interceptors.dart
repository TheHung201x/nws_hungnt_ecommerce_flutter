...
class ApiInterceptors extends QueuedInterceptorsWrapper {
  ...
  void _forceSignIn() {
    ...
    //Open sign-in page
    while (GoRouter.of(AppRouter.shellNavigatorKey.currentContext!).canPop()) {
      GoRouter.of(AppRouter.shellNavigatorKey.currentContext!).pop();
    }
    GoRouter.of(AppRouter.shellNavigatorKey.currentContext!)
