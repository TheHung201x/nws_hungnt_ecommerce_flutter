...
class ProductListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: ProductListPageChild(
          idCategory: categoryEntity.id, nameCategory: categoryEntity.name),
    );
  }
}

class ProductListPageChild extends StatefulWidget {
  const ProductListPageChild(
  ...
  @override
  State<ProductListPageChild> createState() => _ProductListPageChildState();
}

class _ProductListPageChildState extends State<ProductListPageChild> {
